...
import com.im.ImageLakeLK.BecomeaContributor;
...
public class ContributorDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        bc = (BecomeaContributor)getActivity();
        ...
        builder.setView(inflater.inflate(R.layout.edit_profile_dialog, null))
                ...
                .setPositiveButton(R.string.edit, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        // getActivity().finish();
                        SyncThread st = new SyncThread(bc);
                        st.execute();
                    }
                })
                .setNegativeButton(R.string.cancel, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ContributorDialog.this.getDialog().cancel();
                    }
                });
