...
//        
    ...
    public void slice(int wid, int hig, String imgname, int creditid) throws IOException {
        ...
        BufferedImage originalImage = ImageIO.read(new File("C:\\Users\\Nalin\\Documents\\NetBeansProjects\\ImageLK\\build\\web\\uploads\\" + imgname + ".jpg"));
    ...
    public void minSlice(int wid, int hig, String imgname) throws IOException {
        ...
        IMG_WIDTH = wid;
        IMG_HEIGHT = hig;
        String originalpath = "C:\\Users\\Nalin\\Documents\\NetBeansProjects\\ImageLK\\build\\web\\uploads\\" + imgname + ".jpg";
        String newPath = "C:\\Users\\Nalin\\Documents\\NetBeansProjects\\ImageLK\\build\\web\\uploads\\" + imgname + "1.jpg";
